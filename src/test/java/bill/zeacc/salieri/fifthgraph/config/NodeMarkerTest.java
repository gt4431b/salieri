...
public class NodeMarkerTest {
    ...
    public void shouldBeAnAnnotationInterface() {
        // When/Then
        assertThat(NodeMarker.class.isAnnotation()).isTrue();
        assertThat(NodeMarker.class.isInterface()).isTrue();
    }
    ...
    public void shouldBeAnnotatedWithDocumented() {
        // When/Then
        assertThat(NodeMarker.class.isAnnotationPresent(Documented.class)).isTrue();
    }
    ...
    public void shouldHaveRuntimeRetentionPolicy() {
        // When
        Retention retention = NodeMarker.class.getAnnotation(Retention.class);
    ...
    public void shouldTargetAnnotationType() {
        // When
        Target target = NodeMarker.class.getAnnotation(Target.class);
    ...
    public void shouldHaveNoDeclaredMethods() {
        // When/Then
        assertThat(NodeMarker.class.getDeclaredMethods()).isEmpty();
    }
    ...
    public void shouldHaveCorrectPackage() {
        // When/Then
        assertThat(NodeMarker.class.getPackage().getName()).isEqualTo("bill.zeacc.salieri.fifthgraph.config");
    }

    @Test
    @DisplayName("Should be usable as meta-annotation")
    public void shouldBeUsableAsMetaAnnotation() {
        // When/Then - Verify NodeMarker can be applied to annotation types
        assertThat(NodeMarker.class.getAnnotation(Target.class).value()).containsExactly(ElementType.ANNOTATION_TYPE);
        assertThat(NodeMarker.class.isAnnotation()).isTrue();
    }
    ...
    public void shouldHaveAllExpectedAnnotationMetadata() {
        // When
        Annotation[] annotations = NodeMarker.class.getAnnotations();
    ...
    public void shouldHaveCorrectSimpleName() {
        // When/Then
        assertThat(NodeMarker.class.getSimpleName()).isEqualTo("NodeMarker");
    }
    ...
    public void shouldExtendAnnotationInterface() {
        // When/Then
        assertThat(Annotation.class.isAssignableFrom(NodeMarker.class)).isTrue();
        assertThat(NodeMarker.class.getInterfaces()).contains(Annotation.class);
    }

    @Test
    @DisplayName("Should be different from ToolMarker")
    public void shouldBeDifferentFromToolMarker() {
        // When/Then
        assertThat(NodeMarker.class).isNotEqualTo(ToolMarker.class);
        assertThat(NodeMarker.class.getSimpleName()).isNotEqualTo(ToolMarker.class.getSimpleName());
    }
}